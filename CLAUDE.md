...
This file documents shared team standards for Claude Code configuration. Use the `/setup` skill to generate your personal `~/.claude/CLAUDE.md` from this reference.
