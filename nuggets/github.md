...
- Use `/sprout-docs --output jekyll` skill to generate documentation sites
...
- Full runbook: `~/dev/whoabuddy/claude-knowledge/runbook/sprout-docs-github-pages.md`

### 2026-01-07
- Docs generation requires: `.github/workflows/pages.yml`, `docs/Gemfile`, `docs/_config.yml`
- Update `.gitignore` with `sprout-docs.json` and Jekyll artifacts (`docs/_site`, `docs/.jekyll-cache`, etc.)
